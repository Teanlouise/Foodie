...
\newcolumntype{V}{>{\arraybackslash}m{10cm}}
...
\pagebreak
\input{High_Fidelity/High_Report/High_Report}
...
\end{center}
    ...
    \pagebreak     
    \includepdf[pages=1, 
                pagecommand=\subsection{Expert Notes}, 
                width=\textwidth,
                height=\textheight,
                keepaspectratio, 
                frame, offset= 0 -0.5cm]{High_Fidelity/High_Notes.pdf}
                \label{sec:C.5}
